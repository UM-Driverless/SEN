...
unsigned long ulCountTeeth; // Count teeth and reset every time
...
unsigned long ui_cm_in_period; // cm calculated in a count cycle
...
{
    /*EJEMPLO DE CALCULO PARA ulCountTeeth = 1
    ...
    ui_cm_in_period = ( ulCountTeeth * REL_base_calculo );
    ...
    ui_MeterPerSecond_E_2 = ( ui_MeterPerSecond_E_2 / TMR1_period_ms ) ;
